...
// case: CP-HU-41-ADD-04

import { test, expect } from '@playwright/test';
import { TUTOR_REGISTRO_URL } from '../../config';

test.describe('HU41 - Define tu Horario (Paso 2)', () => {
  test('CP-HU-41-ADD-04: Verificar selección de múltiples horarios en rango matutino (07:00-11:00)', async ({ page }) => {
    ...
    // 5. Seleccionar horarios solo en rango matutino: Lun 09:00, Mar 10:00, Mié 11:00
    ...
    // Expected Results:
    // - Los bloques horarios matutinos están seleccionados
    await expect(page.getByRole('button', { name: 'Disponibilidad Lun 09:00' })).toContainText('✓');
    await expect(page.getByRole('button', { name: 'Disponibilidad Mar 10:00' })).toContainText('✓');
