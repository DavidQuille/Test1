...
test.describe('Confirmar Tutoría Presencial', () => {
  test('R5: Confirmar Tutoría Presencial exitosamente con lugar válido', async ({ page }) => {
    ...
    // 5. Ingresar lugar
    await page.getByRole('textbox', { name: 'Lugar de encuentro *' }).fill('Edificio H, Aula 205, Campus Principal');
